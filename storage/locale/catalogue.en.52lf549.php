...
$catalogue = new MessageCatalogue('en', array (
  ...
  array (
    ...
    'flagrow-users-list.admin.nav.users_text' => 'View users list.',
    'flagrow-users-list.admin.page.about_text' => 'View list of registered users.',
    ...
    'flagrow-users-list.admin.page.mail_all_button' => 'Mail to all users',
    'flagrow-users-list.admin.modal_mail.title_text' => 'Message for',
    'flagrow-users-list.admin.modal_mail.title_all_text' => 'all users',
    'flagrow-users-list.admin.modal_mail.email_label' => 'To',
    ...
    'flagrow-users-list.admin.modal_mail.message_label' => 'Message',
    'flagrow-users-list.admin.modal_mail.submit_button' => 'Send',
    'flagrow-users-list.email.default_subject' => '=> flagrow-users-list.ref.default_subject',
    'flagrow-users-list.ref.default_subject' => 'Message from forum administration',
    'flagrow-users-list.ref.users_title' => 'Users',
...
',
    ...
    'tpokorra-post-notification.admin.settings.title' => 'Post Notification Configuration',
    'tpokorra-post-notification.admin.settings.recipients.post_approval.to' => 'Comma separated list of email addresses for the To recipient for approval of new posts',
    'tpokorra-post-notification.admin.settings.recipients.new_discussion.to' => 'Comma separated list of email addresses for the To recipient for new discussions',
    'tpokorra-post-notification.admin.settings.recipients.new_discussion.bcc' => 'Comma separated list of email addresses for the BCC recipient for new discussions',
    'tpokorra-post-notification.admin.settings.recipients.new_post.to' => 'Comma separated list of email addresses for the To recipient for new posts',
    'tpokorra-post-notification.admin.settings.recipients.new_post.bcc' => 'Comma separated list of email addresses for the BCC recipient for new posts',
    'tpokorra-post-notification.admin.settings.recipients.revised_post.to' => 'Comma separated list of email addresses for the To recipient for revised posts',
    'tpokorra-post-notification.admin.settings.recipients.revised_post.bcc' => 'Comma separated list of email addresses for the BCC recipient for revised posts',
    'tpokorra-post-notification.admin.settings.new_discussion' => 'Label for describing a new discussion',
    'tpokorra-post-notification.admin.settings.new_post' => 'Label for describing a new post',
    'tpokorra-post-notification.admin.settings.revised_post' => 'Label for describing a revised post',
    'tpokorra-post-notification.admin.settings.post_approval' => 'Label for describing a new post that needs approval',
    'clarkwinkelmann-status.admin.settings.title' => 'Status Settings',
    'clarkwinkelmann-status.admin.settings.only-countries' => 'Only country flags',
    'clarkwinkelmann-status.admin.settings.enable-text' => 'Allow text status',
    'clarkwinkelmann-status.admin.permissions.see' => 'See status',
    'clarkwinkelmann-status.admin.permissions.set' => 'Define status',
    'clarkwinkelmann-status.admin.permissions.mod' => 'Moderate user status',
    'clarkwinkelmann-status.forum.menu.set-status' => 'Set a status',
    'clarkwinkelmann-status.forum.modal.title' => 'Set status',
    'clarkwinkelmann-status.forum.modal.text-placeholder' => 'What\'s happening?',
    'clarkwinkelmann-status.forum.modal.submit' => 'Submit',
    'clarkwinkelmann-status.forum.modal.clear' => 'Clear',
    ...
    'fof-forum-statistics-widget.admin.settings.title' => 'Widget Settings',
